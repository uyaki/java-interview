...
* [等待通知经典范式](#等待通知经典范式)
* [join](#join)
* [volatile 共享内存](#volatile-共享内存)
* [CountDownLatch 并发工具](#countdownlatch-并发工具)
* [CyclicBarrier 并发工具](#cyclicbarrier-并发工具)
* [线程响应中断](#线程响应中断)
* [线程池 awaitTermination() 方法](#线程池-awaittermination-方法)
* [管道通信](#管道通信)
...
CountDownLatch 也是基于 AQS(AbstractQueuedSynchronizer) 实现的，更多实现参考 [ReentrantLock 实现原理](https://gknoone.github.io/java-interview/#/多线程/ReentrantLock实现原理)
