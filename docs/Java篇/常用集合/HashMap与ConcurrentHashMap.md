...
![img](assets/5cd1d2be77958.jpg)

- 实现

![img](assets/5cd1d2bfd6aba.jpg)
...
![img](assets/5cd1d2ce33795.jpg)

看起来是不是和 1.8 HashMap 结构类似？

其中抛弃了原有的 Segment 分段锁，而采用了 `CAS + synchronized` 来保证并发安全性。

![img](https://i.loli.net/2019/05/08/5cd1d2ceebe02.jpg)
...
[https://crossoverjie.top/2018/07/23/java-senior/ConcurrentHashMap/](https://crossoverjie.top/2018/07/23/java-senior/ConcurrentHashMap/)
